...
public class covidNewUpdate {
	...
	public static void main(String[] args) throws Exception {
		...
		args = new String[] { "C:\\hadoop-3.3.0\\datafile\\input\\dataset.csv",
				"C:\\hadoop-3.3.0\\datafile\\CovidOutputUpdate" };
		...
		job.setJarByClass(covidNewUpdate.class);
